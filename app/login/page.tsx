  ...
  return (
    <form className="space-y-6" onSubmit={onSubmit}>
      ...
      <a
        ...
        className="h-12 w-full flex items-center justify-center gap-3 rounded-lg border border-neutral-800 bg-white text-sm font-bold text-gray-900 hover:bg-gray-100 transition-all transform active:scale-[0.98]"
      >
